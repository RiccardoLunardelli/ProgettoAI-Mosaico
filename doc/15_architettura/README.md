...
flowchart TD
  ...
  E["**ORCHESTRATOR**<br/>(orchestrator.py)<br/>load + validate MR<br/>build deterministic PatchActions<br/>optional LLM propose<br/>filter confidence/gap<br/>commit decision"]
