...
interface RunsPreviewModalPropsInterface {
  showModal: boolean;
  selectedId: string;
  onClose: () => void;
}

function RunsPreviewModalTag({
  showModal,
  selectedId,
  onClose,
}: RunsPreviewModalPropsInterface) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {runsListSlice.detail && selectedId !== "" ? (
            <pre
              style={{
                margin: 0,
                textAlign: "left",
...
export default RunsPreviewModalTag;