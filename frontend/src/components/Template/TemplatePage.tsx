...
function TemplatePageTag() {
  ...
  const HandleExecuteRunOnClick = () => {
    RunTemplateFinishAPI({
      ...
      data: {
        ...
        llm_patch_actions: JSON.parse(inputSliceValue["LLMSuggestionPatch-Edit"]) ?? {},
      },
    });
  };

  useEffect(() => {
    if (!componentState.showLoader) return;
  ...
  }, [componentState.showLoader, componentState.stepOneResponse?.run_id]);
            ...
            {componentState.currentStep == 1 ? (
              <>
                  ...
                  >
                    ...
                    >
                      {(templateListSlice?.value ?? []).length > 0 ? (
                        <>
                          {(templateListSlice?.value ?? []).map((singleId) => {
                            const isSelected =
                              componentState.selected_id === (singleId ?? "");
                ...
                componentState.selected_id !== "" ? (
                  ...
                  <>
                    {componentState.selected_id !== "" && <RunsListSkeleton />}
                  </>
                )}
              </>
            ) : (
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ⚠️{" "}
                        {componentState.stepOneResponse?.ambigouous_count ?? 0}{" "}
                        ambiguità trovate
                      </div>
                            ...
                            <>
                              {componentState.showLoader ? (
                                <Suspense fallback="">
                                  <ProgressTag
                                    percent={
                                      templateListSlice?.percentual?.percent ??
                                      0
                                    }
                                  />
                                </Suspense>
              ...
              <>
                ...
                >
                  ...
                  >
                    ...
                    >
                      # Run ID: {componentState.stepOneResponse?.run_id ?? "-"}
                    </div>
