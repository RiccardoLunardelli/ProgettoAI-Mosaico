...
function ParametersTabTag({
  ...
  function GetHtmlMaskRowsFromStore(parameterId: number): HtmlMaskRowInterface[] {
  ...
  function BuildModalStateFromStore(parameterId: number): ModalFormStateInterface {
    return {
      NameVariable:
        inputSlice.value[
    ...
    <div>
      ...
      >
        {parametersIds.map((singleParameterId, index) => {
          const labelValue =
            inputSlice.value[`${inputPrefix}-Parameters-${singleParameterId}-Label`] ?? "";

          const nameValue =
            inputSlice.value[`${inputPrefix}-Parameters-${singleParameterId}-Name`] ?? "";
          ...
          const enableValue =
            inputSlice.value[`${inputPrefix}-Parameters-${singleParameterId}-Enable`] ===
            "true";

          const aliasValue =
            inputSlice.value[`${inputPrefix}-Parameters-${singleParameterId}-Alias`] ?? "";
