...
def run_pipeline(template_path: str, dictionary_path: str, kb_path: str, template_base_path: str, device_context_path: str, schema_tipo_path: str, output_dir: str, llm_model: str | None, user_class: UsersRepository, run_class: RunRepository, user_id: UUID) -> None:
...
def decide_and_run_patch(dictionary_path: str, kb_path:str, template_base_path: str, matching_path: str, device_context_path: str, llm_model: str, user_class: UsersRepository, run_class: RunRepository, user_id: UUID):
    while True:
        ...
        if choose == 1:
            ...
            if report_path:
                ...
                run_class.save_run(run_report=run_report, user_id=user_id)
